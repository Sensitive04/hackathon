...
const features = [
  {
    icon: Satellite,
    title: "Satellite Urban Heat Planner",
  ...
  {
    icon: ClipboardList,
    title: "Sustainability Activity Tracker",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((f) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-eco-primary transition-colors">
                  {f.title}
                </h3>
